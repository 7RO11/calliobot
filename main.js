...
function boris(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052735984384606208/boris.png"
  );
  return embed;
}
...
function callio(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052733683100045382/callio.png"
  );
  return embed;
}
...
function peter(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052751400699973672/peter.PNG"
  );
  return embed;
}
...
function moris(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052744530631344128/jo.PNG"
  );
  return embed;
}
...
function rosy(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052744970144055337/rosy.PNG"
  );
  return embed;
}
...
function betterBoris(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052750399809015909/oldboris.PNG"
  );
  return embed;
}
...
function prince(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052750544873201694/prin.PNG"
  );
  return embed;
}
...
function dora(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052736903050436609/dora.PNG"
  );
  return embed;
}
...
function coke(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052750693703884950/cody.PNG"
  );
  return embed;
}
...
function cop(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052750906627731456/cop.PNG"
  );
  return embed;
}
...
function demon_child(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052751170340409454/class.PNG"
  );
  return embed;
}
...
function lily(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1078459687634227280/lily.PNG"
  );
  return embed;
}
...
function daddy(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1078461317347811429/dadishchild.PNG"
  );
  return embed;
}
...
function bill(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1078461336809381918/littlebill.PNG"
  );
  return embed;
}
...
function unk(embed, item) {
  ...
  embed.setThumbnail(
    "https://cdn.discordapp.com/attachments/1020421954462818304/1052744969825292368/unk.PNG"
  );
  return embed;
}
...
const commands = [
  ...
  new SlashCommandBuilder()
    .setName("quotemoris")
    .setDescription("idk who this is"),
  new SlashCommandBuilder().setName("quoterosy").setDescription("ginger ho"),
  new SlashCommandBuilder()
    .setName("quoteoldboris")
    .setDescription("the better version"),
  ...
  new SlashCommandBuilder()
    .setName("quotecop")
    .setDescription("oops i killed a man"),
  ...
  new SlashCommandBuilder()
    .setName("quotebill")
    .setDescription("im just a bill"),
  new SlashCommandBuilder()
    .setName("quotedaddy")
    .setDescription("im bout to leave to get some milk"),
  ...
  new SlashCommandBuilder()
    .setName("stop_spamming")
    .setDescription("stop spamming"),
  new SlashCommandBuilder()
    .setName("start_spamming")
    .setDescription("start spamming"),
  new SlashCommandBuilder()
    .setName("tenor")
...
function checkSpam() {
  try {
    const data = fs.readFileSync("./spam.txt", "utf8");
    if (data === "start") {
      return true;
    } else {
      return false;
      ...
      axios
        ...
        .then((res) => {
          ...
          for (let channelId of channels) {
            ...
            channel.send(
              `https://www.youtube.com/watch?v=${link} watch it you wont no balls`
            );
          }
        });
    }
...
client.on("interactionCreate", (interaction) => {
  ...
  } else if (commandName === "stop_spamming") {
    if (interaction.user.id !== "964233909317541899") {
      return interaction.reply("no");
    }
    try {
      fs.writeFileSync("spam.txt", "stop");
    } catch (err) {
      console.error(err);
    }
    interaction.reply("bye");
  } else if (commandName === "start_spamming") {
    if (interaction.user.id !== "964233909317541899") {
      return interaction.reply("no");
    }
    try {
      fs.writeFileSync("spam.txt", "start");
    } catch (err) {
      console.error(err);
    }
